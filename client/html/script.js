...
$(function () {
    ...
    $('.door').on('click', function() {
        ...
        $.post('https://ks-carcontrol/openDoor', JSON.stringify({
                doorIndex: doorIndex
            })
        );
    });
    ...
    $('.seat').on('click', function() {
        ...
        $.post('https://ks-carcontrol/switchSeat', JSON.stringify({
                seatIndex: seatIndex
            })
        );
    });
    ...
    $('.window').on('click', function() {
        ...
        $.post('https://ks-carcontrol/togglewindow', JSON.stringify({
    ...
    $('.engine').on('click', function() {
        if ($(this).parent().hasClass('disabled')) return;
        $.post('https://ks-carcontrol/toggleengine', JSON.stringify({}));
    });
    ...
    document.onkeyup = function (data) {
        if (open) {
            ...
            if ((
                ...
                // Z or Esc
                $.post('https://ks-carcontrol/escape', JSON.stringify({}));
            }
        }
    };
});
